...
<section id="main">
<div class="inner">
<a href="<%=request.getContextPath()%>/newchartcontroller?caidx=1" class="logo" style="font-size: 20px;   z-index: 10000; ">최신음악 </a>
<hr>

<div>             
    <a href="<%=request.getContextPath()%>/newchartcontroller?caidx=1">발라드</a>
    <a href="<%=request.getContextPath()%>/newchartcontroller?caidx=2">댄스</a>
    <a href="<%=request.getContextPath()%>/newchartcontroller?caidx=3">힙합</a>
    <a href="<%=request.getContextPath()%>/newchartcontroller?caidx=4">OST</a>
	<a href="<%=request.getContextPath()%>/newchartcontroller?caidx=5">그 외</a>        
</div>
<hr>
